...
recurseIntoAttrs rec {
  ...
  epnix = recurseIntoAttrs rec {
    epics-base7 = callPackage ./epnix/epics-base { version = "7.0.6"; sha256 = "sha256-5s6tpT11I/unWLH1jt/MubRzZf3Q8LcADu11KZ3cmqw="; };
    epics-base3 = callPackage ./epnix/epics-base { version = "3.15.9"; sha256 = "sha256-QWScmCEaG0F6OW6LPCaFur4W57oRl822p7wpzbYhOuA=";  };
