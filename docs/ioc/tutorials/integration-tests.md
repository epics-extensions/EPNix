...
check that you follow the [NixOS tests-specific pre-requisites].
...
[nixos tests-specific pre-requisites]: ../user-guides/testing/integration-tests.md#pre-requisites
