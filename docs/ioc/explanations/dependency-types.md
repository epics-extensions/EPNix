...
:::{important}
When declaring dependencies for an EPICS top package,
keep the following guidelines in mind:

% When updating this section,
% remember to update the "Packaging a support" module tutorial
...
- Some exceptions,
  ...
  belong to both `depsBuildBuild` and `nativeBuildInputs`.
